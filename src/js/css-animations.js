...
(function () {
  ...
  KeyframeAnimation.prototype.setKeyframe = function (text, css) {
    ...
    // La última especificación dice que debería ser appendRule, no insertRule.
    // Los navegadores también varían en la semántica de esto, sea o no el nuevo
    // las reglas se fusionan con las anteriores en el mismo fotograma clave o si
    // simplemente se reemplazan. Necesito investigar eso más.
    //
  ...
  function Animations() {
    ...
    for (var i = 0; i < styles.length; i++) {
      try {
        ...
        // Intentando interrogar una hoja de estilo de otra
        // el dominio arrojará un error de seguridad
      }
    }
  }
